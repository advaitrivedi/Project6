...
# modified from CLT.py. The training is same as CLT.py. But when testing accuracy, only test the accuracy of the network with one building block replaced.  
# train objective is the activation maps' reconstruction error 
