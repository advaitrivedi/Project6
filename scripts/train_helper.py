...
#     print('HG: FLAGS.train_dir=', FLAGS.train_dir)
#     tf.logging.info(
...
#   print('HG: variables_to_restore=', variables_to_restore)
...
#   print('HG: trainable_scopes=', scopes)
#   variables_to_train = []
#   for scope in scopes:
#     variables = tf.get_collection(tf.GraphKeys.TRAINABLE_VARIABLES, scope)
#     variables_to_train.extend(variables)
#   print('HG: variables_to_train=', variables_to_train)
#   return variables_to_train


# def get_summary_dir(directory, FLAGS, is_train=True):
# 	appendix = '_p'+str(FLAGS.kept_percentage)+'_lr'+str(FLAGS.learning_rate)+'_wdcy'+str(FLAGS.weight_decay)
# 	# appendix = ''
# 	if is_train:
# 		return directory+'/train'+appendix
# 	else:
# 		return directory+'/eval'+appendix

# def get_local_train_checkpoint_path(checkpoint_dir, FLAGS):
# 	appendix = '_p'+str(FLAGS.kept_percentage)+'_lr'+str(FLAGS.learning_rate)+'_wdcy'+str(FLAGS.weight_decay_clt)
# 	return checkpoint_dir+'/train'+appendix
...
def add_l2_loss(output, gnd_output, add_to_collection = True, collection_name='subgraph_losses'):
